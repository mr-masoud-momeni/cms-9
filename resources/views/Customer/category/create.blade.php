        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <form method="post" action="{{route($Model === 'article' ? 'shop.catArticle.save' : 'shop.catProduct.save')}}" id="CategoryForm">
                                {!! csrf_field() !!}
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog margin-top-60">
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" action="{{route($Model === 'article' ? 'shop.catArticle.edit' : 'shop.catProduct.edit')}}" class="CategoryFormEdit">
            ...
            <div class="modal fade" id="DeleteModal" role="dialog">
                <div class="modal-dialog margin-top-60">
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" action="{{route($Model === 'article' ? 'shop.catArticle.delete' : 'shop.catProduct.delete')}}" class="CategoryFormDelete">
                            <div class="modal-body">
                                {!! csrf_field() !!}
                                {{method_field('delete')}}
        ...
        $(document).ready(function () {
            ...
            function printErrorMsg (msg) {
                ...
                if(Array.isArray(msg)){
                    ...
                    $("#ajaxvalidate").find("ul").append('<li>'+msg+'</li>');
                }
            }
